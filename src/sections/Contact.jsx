...
const Contact = () => {
  return (
    <section className="!max-w-[600px] flex justify-center items-center text-center flex-col">
        ...
        <a
            ...
            target="_blank"
            className="contact-email-link mt-10 px-7 py-5 rounded-md font-light border-3 border-primaryColor text-primaryColor font-dm-mono-regular text-[1rem] tracking-wide transition-all duration-300"
        >
            Say Hello!
        </a>
    </section>
